...
<div class="space-y-4 md:space-y-6">
			...
			{:else}
				<div class="divide-y divide-gray-100 dark:divide-gray-700">
					{#each todayMedications as medication}
						<div class="p-4 md:p-5 hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-all duration-200 hover:shadow-md hover:scale-[1.01] {medication.is_taken ? 'bg-green-50 dark:bg-green-900/20' : ''}">
	...
	<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
		{#if $isPacient}
			<a
				href="/collaborations"
				class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-4 md:p-6 hover:shadow-xl hover:shadow-blue-500/10 hover:border-blue-300 dark:hover:border-blue-600 hover:-translate-y-1 transition-all duration-300 group active:scale-95 touch-manipulation"
			>
				<div class="flex items-start gap-3 md:gap-4">
					<div class="p-2 md:p-3 bg-blue-100 dark:bg-blue-900/30 rounded-xl group-hover:bg-blue-200 dark:group-hover:bg-blue-800/50 group-hover:scale-110 group-hover:rotate-3 transition-all duration-300 flex-shrink-0">
					...
					<div class="min-w-0">
						<h4 class="font-semibold text-gray-900 dark:text-gray-100 text-sm md:text-base">Medicii mei</h4>
						<p class="text-xs md:text-sm text-gray-600 dark:text-gray-400">Gestionează colaborările</p>
					</div>
				</div>
			</a>
		{/if}
		...
		<a
			href="/treatments"
			class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-4 md:p-6 hover:shadow-xl hover:shadow-green-500/10 hover:border-green-300 dark:hover:border-green-600 hover:-translate-y-1 transition-all duration-300 group active:scale-95 touch-manipulation"
		>
			<div class="flex items-start gap-3 md:gap-4">
				<div class="p-2 md:p-3 bg-green-100 dark:bg-green-900/30 rounded-xl group-hover:bg-green-200 dark:group-hover:bg-green-800/50 group-hover:scale-110 group-hover:rotate-3 transition-all duration-300 flex-shrink-0">
				...
				<div class="min-w-0">
					<h4 class="font-semibold text-gray-900 dark:text-gray-100 text-sm md:text-base">Tratamente</h4>
					<p class="text-xs md:text-sm text-gray-600 dark:text-gray-400">Vezi planurile tale</p>
				</div>
			</div>
		</a>
		...
		<a
			href="/chat"
			class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-4 md:p-6 hover:shadow-xl hover:shadow-purple-500/10 hover:border-purple-300 dark:hover:border-purple-600 hover:-translate-y-1 transition-all duration-300 group active:scale-95 touch-manipulation"
		>
			<div class="flex items-start gap-3 md:gap-4">
				<div class="p-2 md:p-3 bg-purple-100 dark:bg-purple-900/30 rounded-xl group-hover:bg-purple-200 dark:group-hover:bg-purple-800/50 group-hover:scale-110 group-hover:rotate-3 transition-all duration-300 flex-shrink-0">
				...
				<div class="min-w-0">
					<h4 class="font-semibold text-gray-900 dark:text-gray-100 text-sm md:text-base">Mesaje</h4>
					<p class="text-xs md:text-sm text-gray-600 dark:text-gray-400">Chat cu medicul</p>
				</div>
			</div>
		</a>
	</div>

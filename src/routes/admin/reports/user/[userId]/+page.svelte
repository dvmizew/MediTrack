	...
	{:else if report}
		<div class="grid gap-4 md:grid-cols-3">
			...
			<div class="bg-white/90 dark:bg-gray-900/70 border border-slate-200/70 dark:border-gray-800/70 rounded-xl p-5 space-y-2">
				...
				<p class="text-sm text-gray-700 dark:text-gray-200">Streak maxim: {report.stats?.longest_streak ?? 0}</p>
				<p class="text-sm text-gray-700 dark:text-gray-200">Badge: {report.stats?.current_badge ?? 'N/A'}</p>
			</div>
		</div>

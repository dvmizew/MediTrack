	...
	{:else if user}
		...
		<div class="mt-8">
			...
			<div class="grid grid-cols-1 md:grid-cols-3 gap-4">
				<a href="/settings" class="block p-4 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 hover:border-blue-300 dark:hover:border-blue-600 transition group">
				...
				<a href="/dashboard" class="block p-4 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 hover:border-blue-300 dark:hover:border-blue-600 transition group">
					<div class="flex items-center gap-3">
				...
				<a href="/treatments" class="block p-4 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 hover:border-blue-300 dark:hover:border-blue-600 transition group">
					<div class="flex items-center gap-3">
